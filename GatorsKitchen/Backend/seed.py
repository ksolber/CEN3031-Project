...
LOCATIONS = [
    {
        ...
        "description": (
            ...
            "canned goods, frozen meat, and seasonal produce from the Field & "
            "Fork Farm and Gardens. "
    ...
    },
    {
        ...
        "address": (
            "Plaza of the Americas, University of Florida, Gainesville, FL 32611"
        ),
        "latitude": 29.6481,
        "longitude": -82.3440,
        "description": (
            "All-you-can-eat vegetarian and vegan lunch served outdoors at the Plaza "
            "of the Americas by the Hare Krishna community. A Gainesville tradition "
            "since 1971. Small suggested donation (~$5-6); no one is turned away for "
            "lack of funds."
        ),
    ...
    },
    {
        ...
        "description": (
            ...
            "Civic Media Center. Shoppers pick their own groceries (10-15 lbs per "
            "person). Typically includes fresh produce, bread/pastries, and "
            "nonperishables. No ID or proof of address required."
        ),
        "hours": (
            "2nd and 4th Tuesdays of the month, ~3:00pm - 5:30pm "
            "(numbers given at 1:30pm)"
        ),
    ...
    },
    {
        ...
        "description": (
            ...
            "nonprofit partner agencies across Alachua, Gilchrist, Levy, and Union "
            "counties. Individuals should contact them or visit a partner agency for "
            "direct food access."
        ),
        "hours": "Mon-Fri 8:00am - 4:00pm",
        "eligibility": (
            "Serves partner nonprofits directly; community members contact "
            "them for referrals"
        ),
        "phone": "(352) 336-0839",
    ...
    },
    {
        ...
        "longitude": -82.3306,
        "description": (
            "Emergency food pantry providing a 2-day food supply to households in "
            "need. Clients may visit once every 28 days. Must apply in person. "
            "Serves the elderly, disabled, homeless, and working poor with families."
        ),
        "hours": "Mon-Thu 9:00am - 12:00pm",
        "eligibility": (
            "Alachua County residents; photo ID and Social Security card required"
        ),
        "phone": "(352) 372-8162",
