...
// TEST-01
// Verify that a user can successfully view the current availability status of food pantries on teh Home screen list.
...
// TEST-02
// Verify that a user can clearly see when a food pantry is currently unavailable on the home screen list.
